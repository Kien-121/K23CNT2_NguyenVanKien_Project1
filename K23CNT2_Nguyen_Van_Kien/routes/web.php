...
Route::get('/nvk-user/thanhtoan/{product_id}', [NVK_CT_HOA_DONController::class, 'nvkthanhtoan'])->name('nvkuser.nvkthanhtoan');

// Route để xử lý thanh toán
Route::post('/nvk-user/thanhtoan', [NVK_CT_HOA_DONController::class, 'storeThanhtoan'])->name('nvkuser.storeThanhtoan');
// create hóa đơn user
